...
<nav class="navbar navbar-dark mb-4">
    <div class="container-fluid">
        ...
        <div>
            ...
            <a href="<?php echo e(route('summary')); ?>" class="btn btn-light btn-sm me-2">
...
<div class="container-fluid px-4">
    ...
    <div class="filter-section">
        <form method="GET" action="<?php echo e(route('anper')); ?>" class="row align-items-center">
            <div class="col-md-2">
            ...
            <div class="col-md-4">
                <?php if($selectedPeriode != 'all'): ?>
                    <a href="<?php echo e(route('anper')); ?>" class="btn btn-outline-secondary">
                        <i class="bi bi-x-circle"></i> Reset Filter
                    </a>
                    <span class="ms-3 text-muted">
                        <i class="bi bi-calendar-check"></i>
                        Menampilkan: <strong><?php echo e($selectedPeriode); ?></strong>
                    </span>
                <?php endif; ?>
            </div>
        </form>
    ...
    <div class="grand-total-card mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="mb-0 opacity-75">Periode: <?php echo e($selectedPeriode); ?></p>
            </div>
    ...
    <div class="card stat-card anper-card anper-pms mb-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    ...
                    <div style="font-size: 1.6rem; font-weight: 700;">
                        Rp <?php echo e(number_format($data['pms']['total_realisasi'], 0, ',', '.')); ?>

                    </div>
                    <span class="badge bg-white text-dark summary-badge">
                        <?php echo e($data['pms']['persentase']); ?>% dari Anggaran
                    </span>
                </div>
            </div>
        </div>
        <div class="card-body py-4">
            <div class="row g-3">
                <?php $__currentLoopData = $data['pms']['pendapatan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-12">
                    <div class="pendapatan-card">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <i class="<?php echo e($item['icon']); ?> pendapatan-icon text-<?php echo e($item['color']); ?>"></i>
                            </div>
                            <div class="col">
                                <div class="pendapatan-label"><?php echo e($item['label']); ?></div>
                                <div class="pendapatan-value text-<?php echo e($item['color']); ?>">
                                    Rp <?php echo e(number_format($item['realisasi'], 0, ',', '.')); ?>

                                </div>
                                <div class="pendapatan-anggaran">
                                    Anggaran: Rp <?php echo e(number_format($item['anggaran'], 0, ',', '.')); ?>

                                </div>
                                <div class="mt-2">
                                    <div class="d-flex justify-content-between mb-1">
                                        <small class="text-muted">Realisasi vs Anggaran</small>
                                        <small class="fw-bold text-<?php echo e($item['color']); ?>"><?php echo e($item['persentase']); ?>%</small>
                                    </div>
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-<?php echo e($item['color']); ?>"
                                            style="width: <?php echo e(min($item['persentase'], 100)); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="card stat-card anper-card anper-jai mb-4">
        <div class="card-header anper-header-jai text-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    <div style="font-size: 0.8rem; opacity: 0.8;">Total Realisasi</div>
                    <div style="font-size: 1.6rem; font-weight: 700;">
                        Rp <?php echo e(number_format($data['jai']['total_realisasi'], 0, ',', '.')); ?>

                    </div>
                    <span class="badge bg-white text-dark summary-badge">
                        <?php echo e($data['jai']['persentase']); ?>% dari Anggaran
                    </span>
                </div>
            </div>
        </div>
        <div class="card-body py-4">
            <div class="row g-3">
                <?php $__currentLoopData = $data['jai']['pendapatan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-12">
                    <div class="pendapatan-card">
                        <div class="row align-items-center">
                            <div class="col-auto">
    ...
    <div class="card stat-card anper-card anper-legi mb-4">
        <div class="card-header anper-header-legi text-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    <div style="font-size: 0.8rem; opacity: 0.8;">Total Realisasi</div>
                    <div style="font-size: 1.6rem; font-weight: 700;">
                        Rp <?php echo e(number_format($data['legi']['total_realisasi'], 0, ',', '.')); ?>

                    </div>
                    <span class="badge bg-white text-dark summary-badge">
                        <?php echo e($data['legi']['persentase']); ?>% dari Anggaran
                    </span>
                </div>
            </div>
        </div>
        <div class="card-body py-4">
            <div class="row g-3">
                <?php $__currentLoopData = $data['legi']['pendapatan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4">
    ...
    <div class="card stat-card anper-card anper-epi mb-4">
        <div class="card-header anper-header-epi text-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    <div style="font-size: 0.8rem; opacity: 0.8;">Total Realisasi</div>
                    <div style="font-size: 1.6rem; font-weight: 700;">
                        Rp <?php echo e(number_format($data['epi']['total_realisasi'], 0, ',', '.')); ?>

                    </div>
                    <span class="badge bg-white text-dark summary-badge">
                        <?php echo e($data['epi']['persentase']); ?>% dari Anggaran
                    </span>
                </div>
            </div>
        </div>
        <div class="card-body py-4">
            <div class="row g-3 justify-content-center">
                <?php $__currentLoopData = $data['epi']['pendapatan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-5">
                    <div class="pendapatan-card text-center">
                        <i class="<?php echo e($item['icon']); ?> pendapatan-icon text-<?php echo e($item['color']); ?>"></i>
                        <div class="pendapatan-label"><?php echo e($item['label']); ?></div>
    ...
    <div class="card stat-card anper-card anper-bima mb-4">
        <div class="card-header anper-header-bima text-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    <div style="font-size: 0.8rem; opacity: 0.8;">Total Realisasi</div>
                    <div style="font-size: 1.6rem; font-weight: 700;">
                        Rp <?php echo e(number_format($data['bima']['total_realisasi'], 0, ',', '.')); ?>

                    </div>
                    <span class="badge bg-white text-dark summary-badge">
                        <?php echo e($data['bima']['persentase']); ?>% dari Anggaran
                    </span>
                </div>
            </div>
        </div>
        <div class="card-body py-4">
            <div class="row g-3">
                <?php $__currentLoopData = $data['bima']['pendapatan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4">
                    <div class="pendapatan-card text-center">
                        <i class="<?php echo e($item['icon']); ?> pendapatan-icon text-<?php echo e($item['color']); ?>"></i>
                        <div class="pendapatan-label"><?php echo e($item['label']); ?></div>
...
<?php if($selectedPeriode != 'all'): ?>
<script>
    const anperData = <?php echo json_encode($data, 15, 512) ?>;
...
<?php /**PATH D:\project ai\lhgk\resources\views/anper.blade.php ENDPATH**/ ?>