...
<nav class="navbar navbar-dark mb-4">
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center ms-3">
            ...
            @else
                <span class="badge bg-danger" title="{{ $dbError ?? 'Unknown' }}">DB: Disconnected</span>
            @endif
        </div>
    </div>
</nav>
            ...
            <div class="stat-card p-3">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-striped mb-0">
                        ...
                        <tbody>
                            @foreach(['wilayah_1' => 'Wilayah 1', 'wilayah_2' => 'Wilayah 2', 'wilayah_3' => 'Wilayah 3', 'wilayah_4' => 'Wilayah 4'] as $key => $label)
                            <tr>
                                <td>
                                    <strong class="text-primary">{{ $label }}</strong>
                                </td>
                                <td class="text-end">
                                    <span class="fw-semibold">Rp {{ number_format($segmentWilayahData['marine'][$key]['derum'], 0, ',', '.') }}</span>
                                </td>
                                <td class="text-end">
                                    <span class="fw-semibold">Rp {{ number_format($segmentWilayahData['marine'][$key]['non_derum'], 0, ',', '.') }}</span>
                                </td>
                                <td class="text-end">
                                    <strong class="text-success" style="font-size: 1.1em">Rp {{ number_format($segmentWilayahData['marine'][$key]['total'], 0, ',', '.') }}</strong>
                                </td>
                            </tr>
                            @endforeach
                            <!-- Total Row -->
                            <tr class="table-warning">
                                ...
                                <td class="text-end">
                                    <strong>Rp {{ number_format($summaryData['marine']['derum']['realisasi'], 0, ',', '.') }}</strong>
                                </td>
                                <td class="text-end">
                                    <strong>Rp {{ number_format($summaryData['marine']['non_derum']['realisasi'], 0, ',', '.') }}</strong>
                                </td>
                                <td class="text-end">
                                    <strong class="text-success" style="font-size: 1.2em">Rp {{ number_format($summaryData['marine']['total'], 0, ',', '.') }}</strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                ...
                                <strong class="text-primary">
                                    ...
                                    @endphp
                                    {{ $wilayahNames[$highestWilayahName] }}
                                </strong>
                                <div><small>Rp {{ number_format($highestWilayah['total'], 0, ',', '.') }}</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                ...
                                <strong class="text-info">
                                    ...
                                    @endphp
                                    {{ $wilayahNames[$derumDominant] }}
                                </strong>
                                <div><small>Rp {{ number_format($segmentWilayahData['marine'][$derumDominant]['derum'], 0, ',', '.') }}</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                ...
                                <strong class="text-warning">
                                    ...
                                    @endphp
                                    {{ $wilayahNames[$nonDerumDominant] }}
                                </strong>
                                <div><small>Rp {{ number_format($segmentWilayahData['marine'][$nonDerumDominant]['non_derum'], 0, ',', '.') }}</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                ...
                                <strong class="text-secondary">
                                    Rp {{ number_format($summaryData['marine']['total'] / 4, 0, ',', '.') }}
                                </strong>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            <div class="stat-card p-4">
                ...
                <div class="metric-value text-primary">Rp {{ number_format($summaryData['marine']['total'], 0, ',', '.') }}</div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="sub-segment sub-segment-marine">
                ...
                <div class="d-flex justify-content-between align-items-center mt-2">
                    <div>
                        <div class="metric-value" style="font-size:1.4rem">Rp {{ number_format($summaryData['marine']['derum']['realisasi'], 0, ',', '.') }}</div>
                        <small class="text-muted">Realisasi</small>
                    </div>
                    <div class="text-end">
                        <span class="badge bg-primary" style="font-size:1rem">{{ $summaryData['marine']['derum']['persentase'] }}%</span>
                        <div><small class="text-muted">Anggaran: Rp {{ number_format($summaryData['marine']['derum']['anggaran'], 0, ',', '.') }}</small></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="sub-segment sub-segment-marine">
                ...
                <div class="d-flex justify-content-between align-items-center mt-2">
                    <div>
                        <div class="metric-value" style="font-size:1.4rem">Rp {{ number_format($summaryData['marine']['non_derum']['realisasi'], 0, ',', '.') }}</div>
                        <small class="text-muted">Realisasi</small>
                    </div>
                    <div class="text-end">
                        <span class="badge bg-primary" style="font-size:1rem">{{ $summaryData['marine']['non_derum']['persentase'] }}%</span>
                        <div><small class="text-muted">Anggaran: Rp {{ number_format($summaryData['marine']['non_derum']['anggaran'], 0, ',', '.') }}</small></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="stat-card p-3">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-3 text-center mb-3">
                        <div id="marineDonut_{{ $key }}" role="img" aria-label="Distribusi Marine {{ $label }}"></div>
                        <div class="mt-2"><small><strong>{{ $label }}</strong></small></div>
                    </div>
                    @endforeach
                </div>
            </div>
                ...
                <table class="table table-sm table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">Rp {{ number_format($segmentWilayahData['marine'][$key]['derum'], 0, ',', '.') }}</td>
                            <td class="text-end">Rp {{ number_format($segmentWilayahData['marine'][$key]['non_derum'], 0, ',', '.') }}</td>
                            <td class="text-end"><strong>Rp {{ number_format($segmentWilayahData['marine'][$key]['total'], 0, ',', '.') }}</strong></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="stat-card p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="metric-value text-warning">Rp {{ number_format($summaryData['bbm']['realisasi'], 0, ',', '.') }}</div>
                    </div>
                    <div class="text-end">
                        <span class="badge bg-warning text-dark" style="font-size:1.2rem">{{ $summaryData['bbm']['persentase'] }}%</span>
                        <div class="mt-2"><small class="text-muted">Anggaran: Rp {{ number_format($summaryData['bbm']['anggaran'], 0, ',', '.') }}</small></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-striped mb-0">
                        ...
                        <tbody>
                            @foreach(['wilayah_1' => 'Wilayah 1', 'wilayah_2' => 'Wilayah 2', 'wilayah_3' => 'Wilayah 3', 'wilayah_4' => 'Wilayah 4'] as $key => $label)
                            <tr>
                                <td><strong class="text-warning">{{ $label }}</strong></td>
                                <td class="text-end">Rp {{ number_format($segmentWilayahData['bbm'][$key] ?? 0, 0, ',', '.') }}</td>
                            </tr>
                            @endforeach
                            <tr class="table-warning">
                                <td><strong>TOTAL SEMUA WILAYAH</strong></td>
                                <td class="text-end"><strong class="text-warning">Rp {{ number_format($summaryData['bbm']['realisasi'] ?? array_sum($segmentWilayahData['bbm'] ?? []), 0, ',', '.') }}</strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                            ...
                            <div class="text-center">
                                ...
                                <strong class="text-warning">
                                    @php
                                        ...
                                        $wilayahNames = ['wilayah_1' => 'Wilayah 1', 'wilayah_2' => 'Wilayah 2', 'wilayah_3' => 'Wilayah 3', 'wilayah_4' => 'Wilayah 4'];
                                    @endphp
                                    {{ $highestKey ? $wilayahNames[$highestKey] : '-' }}
                                </strong>
                                <div><small>Rp {{ number_format($bbmCollect->get($highestKey, 0), 0, ',', '.') }}</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                <h6 class="text-muted mb-1">Rata-rata per Wilayah</h6>
                                <strong class="text-secondary">
                                    Rp {{ number_format((($summaryData['bbm']['realisasi'] ?? array_sum($segmentWilayahData['bbm'] ?? [])) / 4), 0, ',', '.') }}
                                </strong>
                                <div><small>dari 4 wilayah</small></div>
                            </div>
                        </div>
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                ...
                                <strong class="text-info">
                                    ...
                                    @endphp
                                    {{ $lowestKey ? $wilayahNames[$lowestKey] : '-' }}
                                </strong>
                                <div><small>Rp {{ number_format($bbmCollect->get($lowestKey, 0), 0, ',', '.') }}</small></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="stat-card p-4">
                ...
                <div class="metric-value text-info">Rp {{ number_format($summaryData['air']['total'], 0, ',', '.') }}</div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="sub-segment sub-segment-air">
                ...
                <div class="mt-2">
                    <div class="metric-value" style="font-size:1.2rem">Rp {{ number_format($summaryData['air']['air_kapal']['realisasi'], 0, ',', '.') }}</div>
                    <div class="d-flex justify-content-between align-items-center mt-1">
                        <small class="text-muted">Realisasi</small>
                        <span class="badge bg-info" style="font-size:0.85rem">{{ $summaryData['air']['air_kapal']['persentase'] }}%</span>
                    </div>
                    <small class="text-muted">Anggaran: Rp {{ number_format($summaryData['air']['air_kapal']['anggaran'], 0, ',', '.') }}</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="sub-segment sub-segment-air">
                ...
                <div class="mt-2">
                    <div class="metric-value" style="font-size:1.2rem">Rp {{ number_format($summaryData['air']['air_umum']['realisasi'], 0, ',', '.') }}</div>
                    <div class="d-flex justify-content-between align-items-center mt-1">
                        <small class="text-muted">Realisasi</small>
                        <span class="badge bg-info" style="font-size:0.85rem">{{ $summaryData['air']['air_umum']['persentase'] }}%</span>
                    </div>
                    <small class="text-muted">Anggaran: Rp {{ number_format($summaryData['air']['air_umum']['anggaran'], 0, ',', '.') }}</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="sub-segment sub-segment-air">
                ...
                <div class="mt-2">
                    <div class="metric-value" style="font-size:1.2rem">Rp {{ number_format($summaryData['air']['air_kontrakor']['realisasi'], 0, ',', '.') }}</div>
                    <div class="d-flex justify-content-between align-items-center mt-1">
                        <small class="text-muted">Realisasi</small>
                        <span class="badge bg-info" style="font-size:0.85rem">{{ $summaryData['air']['air_kontrakor']['persentase'] }}%</span>
                    </div>
                    <small class="text-muted">Anggaran: Rp {{ number_format($summaryData['air']['air_kontrakor']['anggaran'], 0, ',', '.') }}</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 mt-3">
            <div class="stat-card p-3">
                ...
                <div class="row">
                    @foreach(['wilayah_1' => 'Wilayah 1', 'wilayah_2' => 'Wilayah 2', 'wilayah_3' => 'Wilayah 3', 'wilayah_4' => 'Wilayah 4'] as $key => $label)
                    <div class="col-6 col-md-3 text-center mb-3">
                        <div id="airDonut_{{ $key }}" role="img" aria-label="Distribusi Air {{ $label }}"></div>
                        <div class="mt-2"><small><strong>{{ $label }}</strong></small></div>
                    </div>
                    @endforeach
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            @foreach(['wilayah_1' => 'Wilayah 1', 'wilayah_2' => 'Wilayah 2', 'wilayah_3' => 'Wilayah 3', 'wilayah_4' => 'Wilayah 4'] as $key => $label)
                            <tr>
                                <td><strong class="text-info">{{ $label }}</strong></td>
                                <td class="text-end">Rp {{ number_format($segmentWilayahData['air'][$key]['air_kapal'] ?? 0, 0, ',', '.') }}</td>
                                <td class="text-end">Rp {{ number_format($segmentWilayahData['air'][$key]['air_umum'] ?? 0, 0, ',', '.') }}</td>
                                <td class="text-end">Rp {{ number_format($segmentWilayahData['air'][$key]['air_kontrakor'] ?? 0, 0, ',', '.') }}</td>
                                <td class="text-end"><strong>Rp {{ number_format($segmentWilayahData['air'][$key]['total'] ?? 0, 0, ',', '.') }}</strong></td>
                            </tr>
                            @endforeach
                            <tr class="table-warning">
                                <td><strong>TOTAL SEMUA WILAYAH</strong></td>
                                <td class="text-end"><strong>Rp {{ number_format($sum_air_kapal, 0, ',', '.') }}</strong></td>
                                <td class="text-end"><strong>Rp {{ number_format($sum_air_umum, 0, ',', '.') }}</strong></td>
                                <td class="text-end"><strong>Rp {{ number_format($sum_air_kontrakor, 0, ',', '.') }}</strong></td>
                                <td class="text-end"><strong class="text-info">Rp {{ number_format($sum_air_total ?: ($summaryData['air']['total'] ?? 0), 0, ',', '.') }}</strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                            ...
                            <div class="text-center">
                                ...
                                <strong class="text-info">
                                    @php
                                        ...
                                        $wilayahNames = ['wilayah_1' => 'Wilayah 1', 'wilayah_2' => 'Wilayah 2', 'wilayah_3' => 'Wilayah 3', 'wilayah_4' => 'Wilayah 4'];
                                    @endphp
                                    {{ $highestKeyAir ? $wilayahNames[$highestKeyAir] : '-' }}
                                </strong>
                                <div><small>Rp {{ number_format($highestAir['total'] ?? 0, 0, ',', '.') }}</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                <h6 class="text-muted mb-1">Rata-rata per Wilayah</h6>
                                <strong class="text-secondary">Rp {{ number_format((($sum_air_total ?: ($summaryData['air']['total'] ?? 0)) / 4), 0, ',', '.') }}</strong>
                                <div><small>dari 4 wilayah</small></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                ...
                                <strong class="text-info">
                                    ...
                                    @endphp
                                    {{ $lowestKeyAir ? $wilayahNames[$lowestKeyAir] : '-' }}
                                </strong>
                                <div><small>Rp {{ number_format($airCollect->get($lowestKeyAir)['total'] ?? 0, 0, ',', '.') }}</small></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="stat-card p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="metric-value text-danger">Rp {{ number_format($summaryData['listrik']['realisasi'], 0, ',', '.') }}</div>
                    </div>
                    <div class="text-end">
                        <span class="badge bg-danger" style="font-size:1.2rem">{{ $summaryData['listrik']['persentase'] }}%</span>
                        <div class="mt-2"><small class="text-muted">Anggaran: Rp {{ number_format($summaryData['listrik']['anggaran'], 0, ',', '.') }}</small></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            @foreach(['wilayah_1' => 'Wilayah 1', 'wilayah_2' => 'Wilayah 2', 'wilayah_3' => 'Wilayah 3', 'wilayah_4' => 'Wilayah 4'] as $key => $label)
                            <tr>
                                <td><strong class="text-danger">{{ $label }}</strong></td>
                                <td class="text-end">Rp {{ number_format($segmentWilayahData['listrik'][$key] ?? 0, 0, ',', '.') }}</td>
                            </tr>
                            @endforeach
                            <tr class="table-warning">
                                <td><strong>TOTAL SEMUA WILAYAH</strong></td>
                                <td class="text-end"><strong class="text-danger">Rp {{ number_format($summaryData['listrik']['realisasi'] ?? $listrikCollect->sum(), 0, ',', '.') }}</strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                ...
                                <div><small>Rp {{ number_format($listrikCollect->get($highestKey, 0), 0, ',', '.') }}</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                <h6 class="text-muted mb-1">Rata-rata per Wilayah</h6>
                                <strong class="text-secondary">Rp {{ number_format((($summaryData['listrik']['realisasi'] ?? $listrikCollect->sum()) / 4), 0, ',', '.') }}</strong>
                                <div><small>dari 4 wilayah</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="bg-light p-3 rounded">
                            <div class="text-center">
                                ...
                                <div><small>Rp {{ number_format($listrikCollect->get($lowestKey, 0), 0, ',', '.') }}</small></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="stat-card p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="metric-value" style="color:var(--accent-equipment)">Rp {{ number_format($summaryData['equipment']['realisasi'] ?? 0, 0, ',', '.') }}</div>
                    </div>
                    <div class="text-end">
                        <span class="badge" style="background:var(--accent-equipment);color:#fff;font-size:1.2rem">{{ $summaryData['equipment']['persentase'] ?? 0 }}%</span>
                        <div class="mt-2"><small class="text-muted">Anggaran: Rp {{ number_format($summaryData['equipment']['anggaran'] ?? 0, 0, ',', '.') }}</small></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="sub-segment sub-segment-equipment">
                                ...
                                <div class="mt-2">
                                    <div class="metric-value" style="font-size:1.2rem">Rp {{ number_format($summaryData['equipment']['proyek']['realisasi'] ?? 0, 0, ',', '.') }}</div>
                                    <div class="d-flex justify-content-between align-items-center mt-1">
                                        <small class="text-muted">Realisasi</small>
                                        <span class="badge" style="background:var(--accent-equipment);color:#fff;font-size:0.85rem">{{ $summaryData['equipment']['proyek']['persentase'] ?? 0 }}%</span>
                                    </div>
                                    <small class="text-muted">Anggaran: Rp {{ number_format($summaryData['equipment']['proyek']['anggaran'] ?? 0, 0, ',', '.') }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="sub-segment sub-segment-equipment">
                                ...
                                <div class="mt-2">
                                    <div class="metric-value" style="font-size:1.2rem">Rp {{ number_format($summaryData['equipment']['sparepark']['realisasi'] ?? 0, 0, ',', '.') }}</div>
                                    <div class="d-flex justify-content-between align-items-center mt-1">
                                        <small class="text-muted">Realisasi</small>
                                        <span class="badge" style="background:var(--accent-equipment);color:#fff;font-size:0.85rem">{{ $summaryData['equipment']['sparepark']['persentase'] ?? 0 }}%</span>
                                    </div>
                                    <small class="text-muted">Anggaran: Rp {{ number_format($summaryData['equipment']['sparepark']['anggaran'] ?? 0, 0, ',', '.') }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="sub-segment sub-segment-equipment">
                                ...
                                <div class="mt-2">
                                    <div class="metric-value" style="font-size:1.2rem">Rp {{ number_format($summaryData['equipment']['maintenance']['realisasi'] ?? 0, 0, ',', '.') }}</div>
                                    <div class="d-flex justify-content-between align-items-center mt-1">
                                        <small class="text-muted">Realisasi</small>
                                        <span class="badge" style="background:var(--accent-equipment);color:#fff;font-size:0.85rem">{{ $summaryData['equipment']['maintenance']['persentase'] ?? 0 }}%</span>
                                    </div>
                                    <small class="text-muted">Anggaran: Rp {{ number_format($summaryData['equipment']['maintenance']['anggaran'] ?? 0, 0, ',', '.') }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="sub-segment sub-segment-equipment">
                                ...
                                <div class="mt-2">
                                    <div class="metric-value" style="font-size:1.2rem">Rp {{ number_format($summaryData['equipment']['lainnya']['realisasi'] ?? 0, 0, ',', '.') }}</div>
                                    <div class="d-flex justify-content-between align-items-center mt-1">
                                        <small class="text-muted">Realisasi</small>
                                        <span class="badge" style="background:var(--accent-equipment);color:#fff;font-size:0.85rem">{{ $summaryData['equipment']['lainnya']['persentase'] ?? 0 }}%</span>
                                    </div>
                                    <small class="text-muted">Anggaran: Rp {{ number_format($summaryData['equipment']['lainnya']['anggaran'] ?? 0, 0, ',', '.') }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-12 mt-3">
            <div class="stat-card p-3">
                ...
                <div class="row">
                    @foreach(['wilayah_1' => 'Wilayah 1', 'wilayah_2' => 'Wilayah 2', 'wilayah_3' => 'Wilayah 3', 'wilayah_4' => 'Wilayah 4'] as $key => $label)
                    <div class="col-6 col-md-3 text-center mb-3">
                        <div id="equipmentDonut_{{ $key }}" role="img" aria-label="Distribusi Equipment {{ $label }}"></div>
                        <div class="mt-2"><small><strong>{{ $label }}</strong></small></div>
                    </div>
                    @endforeach
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            @foreach(['wilayah_1' => 'Wilayah 1', 'wilayah_2' => 'Wilayah 2', 'wilayah_3' => 'Wilayah 3', 'wilayah_4' => 'Wilayah 4'] as $key => $label)
                            <tr>
                                <td><strong style="color:var(--accent-equipment)">{{ $label }}</strong></td>
                                <td class="text-end">Rp {{ number_format($segmentWilayahData['equipment'][$key]['proyek'] ?? 0, 0, ',', '.') }}</td>
                                <td class="text-end">Rp {{ number_format($segmentWilayahData['equipment'][$key]['sparepark'] ?? 0, 0, ',', '.') }}</td>
                                <td class="text-end">Rp {{ number_format($segmentWilayahData['equipment'][$key]['maintenance'] ?? 0, 0, ',', '.') }}</td>
                                <td class="text-end">Rp {{ number_format($segmentWilayahData['equipment'][$key]['lainnya'] ?? 0, 0, ',', '.') }}</td>
                                <td class="text-end"><strong>Rp {{ number_format($segmentWilayahData['equipment'][$key]['total'] ?? 0, 0, ',', '.') }}</strong></td>
                            </tr>
                            @endforeach
                            <tr class="table-warning">
                                <td><strong>TOTAL SEMUA WILAYAH</strong></td>
                                <td class="text-end"><strong>Rp {{ number_format($sum_proyek, 0, ',', '.') }}</strong></td>
                                <td class="text-end"><strong>Rp {{ number_format($sum_sparepark, 0, ',', '.') }}</strong></td>
                                <td class="text-end"><strong>Rp {{ number_format($sum_maintenance, 0, ',', '.') }}</strong></td>
                                <td class="text-end"><strong>Rp {{ number_format($sum_lainnya, 0, ',', '.') }}</strong></td>
                                <td class="text-end"><strong style="color:var(--accent-equipment)">Rp {{ number_format($sum_equipment_total ?: ($summaryData['equipment']['realisasi'] ?? 0), 0, ',', '.') }}</strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    const trendMarine = @json($trendMarine);
    const trendBbm = @json($trendBbm);
    const trendAir = @json($trendAir);
    const trendListrik = @json($trendListrik);
    const trendEquipment = @json($trendEquipment ?? []);
    ...
    const marineWilayah = @json($segmentWilayahData['marine'] ?? []);
    ...
    const bbmDataObj = @json($segmentWilayahData['bbm'] ?? []);
    const bbmSeries = [
    ...
    const airWilayah = @json($segmentWilayahData['air'] ?? []);
    ...
    const equipmentWilayah = @json($segmentWilayahData['equipment'] ?? []);
    ...
    const listrikDataObj = @json($segmentWilayahData['listrik'] ?? []);
    const listrikSeries = [
    ...
    const equipmentDataObj = @json($segmentWilayahData['equipment'] ?? []);
